                    ...
                    <table class="min-w-full bg-white rounded-2xl">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php if($tarifs->count() > 0): ?>
                                <?php $__currentLoopData = $tarifs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tarif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="<?php echo e($index % 2 === 1 ? 'bg-sky-50' : ''); ?>">
                                        <td class="py-4 px-6 text-left font-medium text-gray-900"><?php echo e($tarif->item_name); ?></td>
                                        <td class="py-4 px-6 text-center text-gray-700 font-semibold">Rp <?php echo e(number_format($tarif->price_weekday, 0, ',', '.')); ?></td>
                                        <td class="py-4 px-6 text-center text-gray-700 font-semibold">Rp <?php echo e(number_format($tarif->price_weekend, 0, ',', '.')); ?></td>
                                    </tr>
                            ...
                            <?php if($imagePath): ?>
                                <div class="gallery-item">
                                    ...
                                    <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4 text-white text-left">
                                        <p class="gallery-title"><?php echo e($foto->judul ?: 'Foto Pantai Manggar'); ?></p>
                                    </div>
                                </div>
                            <?php else: ?>
                                <div class="gallery-item">
        ...
        <section id="masukan" class="py-20 bg-sky-50">
            <div class="container">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <div class="lg:col-span-1">
                        ...
                        <div class="space-y-4">
                            ...
                            <a href="https://www.instagram.com/uptdpantaimanggar/" 
                                target="_blank" 
                ...
                <div class="max-w-3xl mx-auto mt-16">
                    ...
                    <form action="<?php echo e(route('masukan.store')); ?>" method="POST" class="bg-white p-8 rounded-2xl shadow-2xl border border-sky-100">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                            <label for="nama" class="block text-gray-700 font-medium mb-2">Nama Lengkap *</label>
                            <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukkan nama lengkap Anda" value="<?php echo e(old('nama')); ?>" required>
                        </div>
                        
                        <div class="form-group">
                            <label for="kontak" class="block text-gray-700 font-medium mb-2">Kontak (Email/Telepon) *</label>
                            <input type="text" name="kontak" id="kontak" class="form-control" placeholder="Email atau nomor telepon yang dapat dihubungi" value="<?php echo e(old('kontak')); ?>" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="jenis" id="jenis" class="form-control" required>
                                ...
                                <option value="Kritik" <?php echo e(old('jenis') == 'Kritik' ? 'selected' : ''); ?>>Kritik</option>
                                <option value="Saran" <?php echo e(old('jenis') == 'Saran' ? 'selected' : ''); ?>>Saran</option>
                                <option value="Pertanyaan" <?php echo e(old('jenis') == 'Pertanyaan' ? 'selected' : ''); ?>>Pertanyaan</option>
                            </select>
                        </div>
                        
                        <div class="form-group">
                            <label for="pesan" class="block text-gray-700 font-medium mb-2">Pesan Anda *</label>
                            <textarea name="pesan" id="pesan" class="form-control" rows="5" placeholder="Tuliskan masukan, saran, atau pertanyaan Anda di sini..." required><?php echo e(old('pesan')); ?></textarea>
                        </div>
        ...
        <div class="footer-container">
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <p class="text-gray-400 mb-2">Sabtu - Minggu: 07:00 - 19:00</p>
                    <p class="text-gray-400">Hari Libur: 06:00 - 20:00</p>
                </div>
            </div>
...
</html><?php /**PATH C:\Users\USER\문서\Kuliah\Semester\Semester 5\Inovasi Sosial\Web kkn\admin-backend\resources\views/welcome.blade.php ENDPATH**/ ?>