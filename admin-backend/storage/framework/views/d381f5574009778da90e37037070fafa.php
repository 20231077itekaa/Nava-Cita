...
<?php $__env->startSection('content'); ?>
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="<?php echo e(route('admin.tarif.create')); ?>" class="inline-flex items-center bg-teal-600 hover:bg-teal-700 text-white font-bold py-2 px-4 rounded-lg shadow-md transition duration-150">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 font-semibold text-gray-900">
                            <?php echo e($tarif->item_name); ?>

                        </td>
                        <td class="px-6 py-4 text-right font-medium text-gray-800">
                            <?php echo e('Rp ' . number_format($tarif->price_weekday, 0, ',', '.')); ?>

                        </td>
                        <td class="px-6 py-4 text-right font-medium text-gray-800">
                            <?php echo e('Rp ' . number_format($tarif->price_weekend, 0, ',', '.')); ?>

                        </td>
                        <td class="px-6 py-4 text-center flex justify-center space-x-2">
                            <a href="<?php echo e(route('admin.tarif.edit', $tarif->id)); ?>" class="text-blue-600 hover:text-blue-900 transition duration-150" title="Edit">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </a>

                            <form action="<?php echo e(route('admin.tarif.destroy', $tarif->id)); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus item tarif ini?');">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\문서\Kuliah\Semester\Semester 5\Inovasi Sosial\Web kkn\admin-backend\resources\views/admin/tarif/index.blade.php ENDPATH**/ ?>