        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <nav class="flex space-x-4">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-gray-600 hover:text-gray-900">Dashboard</a>
                    <a href="<?php echo e(route('admin.foto.index')); ?>" class="text-blue-600 font-semibold">Galeri Foto</a>
                    <a href="<?php echo e(route('admin.tarif.index')); ?>" class="text-gray-600 hover:text-gray-900">Tarif</a>
                    <a href="<?php echo e(route('admin.masukan.index')); ?>" class="text-gray-600 hover:text-gray-900">Masukan</a>
    ...
    <main class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-lg shadow-md border border-gray-200">
            <div class="p-8">
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <h3 class="text-sm font-medium text-red-800">
                                    Terdapat <?php echo e($errors->count()); ?> error dalam form:
                                </h3>
                ...
                <!-- Upload Form -->
                <form action="<?php echo e(route('admin.foto.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-8" id="uploadForm">
                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\USER\문서\Kuliah\Semester\Semester 5\Inovasi Sosial\Web kkn\admin-backend\resources\views/admin/foto/create.blade.php ENDPATH**/ ?>